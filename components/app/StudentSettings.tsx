...
const StudentSettings = ({ isOpen, onClose }: StudentSettingsProps) => {
  // Settings state
  ...
  // Function to render slider components with consistent styling
  const renderSlider = (
    label: string,
    value: number,
    ...
    max: number = 100,
    step: number = 5,
    leftLabel: string = "Slow",
    rightLabel: string = "Fast",
    ...
    <div className="mb-6 pb-6 border-b border-gray-100 last:border-b-0 last:pb-0 last:mb-0">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-sm font-medium text-alterview-indigo">
          {value}%
        </span>
      </div>
      <div className="relative">
        <input
          ...
          value={value}
          onChange={onChange}
          className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-alterview-indigo"
        />
